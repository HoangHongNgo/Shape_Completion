...
comap_checker = 1
if test_pkl:
    with open('/media/dsp/B2B4107BB41043EF/graspnet/comap/scene_0000/realsense/0000.pkl', 'rb') as f:
        a=pickle.load(f)
        print(a.shape)

        mask_path = '/media/dsp/B2B4107BB41043EF/graspnet/scenes/scene_0000/realsense/label/0000.png'
        ...
        camK = np.load('/media/dsp/B2B4107BB41043EF/graspnet/scenes/scene_0000/realsense/camK.npy')
...
if test_depth:
    depth_path = '/media/dsp/B2B4107BB41043EF/graspnet/scenes/scene_0000/realsense/depth/0000.png'
...
if pkl_checker:
    for s in range(0,56):
        for f in range(0,256):
            path = os.path.join('/media/dsp/B2B4107BB41043EF/graspnet/comap', 'scene_%04d'%s, 'realsense', '%04d.pkl'%f)
...
if comap_checker:
    s = 0
    f = 0
    path = os.path.join('/media/dsp/JTsai/graspnet/comap', 'scene_%04d' % s, 'realsense')
